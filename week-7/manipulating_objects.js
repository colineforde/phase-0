...
//What tests did you have trouble passing? What did you do to make it pass? Why did that work? - I initially had trouble passing the children property. I wasn't sure if we should create an array within a hash, or add .[child name] after .children to create a separate hash, but it turned out the latter was correct. 
// How difficult was it to add and delete properties outside of the object itself? - Not too hard. The syntax is different from Ruby, so I had to look up how to add it, but it was easy to implement. 
// What did you learn about manipulating objects in this challenge? - I learned that you can add other objects to an object, like how we linked the adam object to be the property of tarah.spouse, which I wasn't aware of previously. 
//
